...
class vim(
  ...
  Boolean       $set_as_default    = $vim::params::set_as_default,
  String        $package           = $vim::params::package,
  String        $set_editor_cmd    = $vim::params::set_editor_cmd,
  String        $test_editor_set   = $vim::params::test_editor_set,
  String        $conf_file         = $vim::params::conf,
  Boolean       $opt_nocompatible  = $vim::params::nocompatible,
  String        $opt_backspace     = $vim::params::backspace,
  String        $opt_bg_shading    = $vim::params::background,
  Boolean       $opt_indent        = $vim::params::indent,
  Boolean       $opt_lastposition  = $vim::params::lastposition,
  Boolean       $opt_matchparen    = $vim::params::matchparen,
  Boolean       $opt_powersave     = $vim::params::powersave,
  Boolean       $opt_ruler         = $vim::params::ruler,
